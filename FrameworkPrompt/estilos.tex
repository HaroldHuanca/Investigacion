...
\titleformat{\section}[display]
  {\normalfont\fontsize{12}{14}\bfseries\centering\setstretch{1.5}} % Quitamos \uppercase de aquí
  {CAPÍTULO \thesection}
  {1ex}
...
\titleformat{\subsection}
  {\normalfont\fontsize{12}{14}\bfseries\setstretch{1.5}}
  {\thesubsection}{1em}{}
...
% Lista para Nivel IV (Alineada con Parrafo IV)
\newlist{listaIV}{itemize}{1}
\setlist[listaIV]{
    label=\textbullet,
    nosep,
    leftmargin=8.6em, % 4.5em del parrafo + 1.5em para la viñeta
    topsep=0.5em,     % Aquí controlamos la distancia exacta al título
    before=\setstretch{1.5},
    after=\vspace{1em}
}
...
\setlist[listaOE]{
    ...
    leftmargin=7.5em,             % Alineado con el margen del Título III
...
\setlist[listaPE]{
    ...
    leftmargin=7.3em,             % Alineado con el margen del Título III
    labelsep=1em,               % Espacio entre el código y el texto
    before=\setstretch{1.5},
    nosep                       % Elimina espacios verticales excesivos
}

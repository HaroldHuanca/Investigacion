...
\parrafoIII{%
Diseño no experimental de tipo transversal. Se evaluará el rendimiento del sistema y la exactitud de los registros de stock en condiciones reales de operación durante un periodo determinado de tres meses.%
}
